...
class LeaveController extends Controller
{
    ...
    //         return ApiResponse::error('You are not authorized to access this data.', [], 403);
    //     }
    ...
    //                     $attendanceData[$dayStr]['present'] = $leave->is_wfh == '1' ? 1 : 0;
    //                     $attendanceData[$dayStr]['leave_type'] = $leave->leave_type === 'Multiple Days Leave' ? 'Full Leave' : $leave->leave_type;
    ...
    //     return ApiResponse::success('User availability fetched successfully', $response);
    // }
